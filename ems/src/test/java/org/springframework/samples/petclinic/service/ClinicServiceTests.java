...
class ClinicServiceTests {
	...
	void shouldFindSingleOwnerWithPet() {
		...
		assertThat(owner.getPets().get(0).getType().getName()).isEqualTo("bell");
	}
	...
	void shouldFindAllPetTypes() {
		...
		assertThat(petType1.getName()).isEqualTo("bell");
		PetType petType4 = EntityUtils.getById(petTypes, PetType.class, 4);
		assertThat(petType4.getName()).isEqualTo("cgi");
	}
	...
	void shouldFindVets() {
		...
		assertThat(vet.getSpecialties().get(1).getName()).isEqualTo("Toronto");
	}
