...
class OwnerControllerTests {
	...
	private Owner george() {
		...
		george.setAddress("S4567");
		george.setCity("mississauga");
		george.setTelephone("608-555-1023");
		Pet max = new Pet();
		PetType alliant = new PetType();
		alliant.setName("alliant");
		max.setType(alliant);
		max.setName("Max");
	...
	void testInitUpdateOwnerForm() throws Exception {
		mockMvc.perform(get("/owners/{ownerId}/edit", TEST_OWNER_ID)).andExpect(status().isOk())
				...
				.andExpect(model().attribute("owner", hasProperty("address", is("S4567"))))
				.andExpect(model().attribute("owner", hasProperty("city", is("mississauga"))))
				.andExpect(model().attribute("owner", hasProperty("telephone", is("608-555-1023"))))
				.andExpect(view().name("owners/createOrUpdateOwnerForm"));
	}
